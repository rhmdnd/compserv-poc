...
// AssemblyOscalMetadataBackMatter - A collection of resources, which may be included directly or by reference.
type AssemblyOscalMetadataBackMatter struct {

	Resources []Resource `json:"resources,omitempty"`
}

// AssertAssemblyOscalMetadataBackMatterRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataBackMatterRequired(obj AssemblyOscalMetadataBackMatter) error {
...
// AssertRecurseAssemblyOscalMetadataBackMatterRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataBackMatter (e.g. [][]AssemblyOscalMetadataBackMatter), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataBackMatterRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataBackMatter, ok := obj.(AssemblyOscalMetadataBackMatter)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataBackMatterRequired(aAssemblyOscalMetadataBackMatter)
	})
}
