...
// AssemblyOscalSspNetworkArchitecture - A description of the system's network architecture, optionally supplemented by diagrams that illustrate the network architecture.
type AssemblyOscalSspNetworkArchitecture struct {
...
// AssertAssemblyOscalSspNetworkArchitectureRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalSspNetworkArchitectureRequired(obj AssemblyOscalSspNetworkArchitecture) error {
...
// AssertRecurseAssemblyOscalSspNetworkArchitectureRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalSspNetworkArchitecture (e.g. [][]AssemblyOscalSspNetworkArchitecture), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalSspNetworkArchitectureRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalSspNetworkArchitecture, ok := obj.(AssemblyOscalSspNetworkArchitecture)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalSspNetworkArchitectureRequired(aAssemblyOscalSspNetworkArchitecture)
	})
}
