...
// AssemblyOscalCatalogGroup - A group of controls, or of groups of controls.
type AssemblyOscalCatalogGroup struct {
...
// AssertAssemblyOscalCatalogGroupRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalCatalogGroupRequired(obj AssemblyOscalCatalogGroup) error {
...
// AssertRecurseAssemblyOscalCatalogGroupRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalCatalogGroup (e.g. [][]AssemblyOscalCatalogGroup), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalCatalogGroupRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalCatalogGroup, ok := obj.(AssemblyOscalCatalogGroup)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalCatalogGroupRequired(aAssemblyOscalCatalogGroup)
	})
}
