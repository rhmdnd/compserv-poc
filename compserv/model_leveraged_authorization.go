...
// AssertLeveragedAuthorizationRequired checks if the required fields are not zero-ed
func AssertLeveragedAuthorizationRequired(obj LeveragedAuthorization) error {
	elements := map[string]interface{}{
		"uuid": obj.Uuid,
		"title": obj.Title,
		"party-uuid": obj.PartyUuid,
		"date-authorized": obj.DateAuthorized,
	}
...
// AssertRecurseLeveragedAuthorizationRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of LeveragedAuthorization (e.g. [][]LeveragedAuthorization), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseLeveragedAuthorizationRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aLeveragedAuthorization, ok := obj.(LeveragedAuthorization)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertLeveragedAuthorizationRequired(aLeveragedAuthorization)
	})
}
