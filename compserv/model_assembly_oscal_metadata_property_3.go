...
// AssertAssemblyOscalMetadataProperty3Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataProperty3Required(obj AssemblyOscalMetadataProperty3) error {
...
// AssertRecurseAssemblyOscalMetadataProperty3Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataProperty3 (e.g. [][]AssemblyOscalMetadataProperty3), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataProperty3Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataProperty3, ok := obj.(AssemblyOscalMetadataProperty3)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataProperty3Required(aAssemblyOscalMetadataProperty3)
	})
}
