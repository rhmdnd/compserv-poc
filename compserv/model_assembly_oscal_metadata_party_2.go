...
// AssemblyOscalMetadataParty2 - A responsible entity which is either a person or an organization.
type AssemblyOscalMetadataParty2 struct {
	...
	Addresses []AssemblyOscalMetadataAddress2 `json:"addresses,omitempty"`
...
// AssertAssemblyOscalMetadataParty2Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataParty2Required(obj AssemblyOscalMetadataParty2) error {
	...
	for _, el := range obj.Addresses {
		if err := AssertAssemblyOscalMetadataAddress2Required(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertRecurseAssemblyOscalMetadataParty2Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataParty2 (e.g. [][]AssemblyOscalMetadataParty2), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataParty2Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataParty2, ok := obj.(AssemblyOscalMetadataParty2)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataParty2Required(aAssemblyOscalMetadataParty2)
	})
}
