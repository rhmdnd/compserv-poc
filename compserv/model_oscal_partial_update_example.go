...
type OscalPartialUpdateExample struct {

	Uuid string `json:"uuid,omitempty"`

	Metadata OscalPartialUpdateExampleMetadata `json:"metadata,omitempty"`
}

// AssertOscalPartialUpdateExampleRequired checks if the required fields are not zero-ed
func AssertOscalPartialUpdateExampleRequired(obj OscalPartialUpdateExample) error {
	if err := AssertOscalPartialUpdateExampleMetadataRequired(obj.Metadata); err != nil {
		return err
	}
	return nil
}

// AssertRecurseOscalPartialUpdateExampleRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of OscalPartialUpdateExample (e.g. [][]OscalPartialUpdateExample), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseOscalPartialUpdateExampleRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aOscalPartialUpdateExample, ok := obj.(OscalPartialUpdateExample)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertOscalPartialUpdateExampleRequired(aOscalPartialUpdateExample)
	})
}
