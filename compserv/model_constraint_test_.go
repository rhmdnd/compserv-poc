...
// AssertConstraintTestRequired checks if the required fields are not zero-ed
func AssertConstraintTestRequired(obj ConstraintTest) error {
...
// AssertRecurseConstraintTestRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ConstraintTest (e.g. [][]ConstraintTest), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseConstraintTestRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aConstraintTest, ok := obj.(ConstraintTest)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertConstraintTestRequired(aConstraintTest)
	})
}
