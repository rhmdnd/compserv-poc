...
// AssertImplementedComponentRequired checks if the required fields are not zero-ed
func AssertImplementedComponentRequired(obj ImplementedComponent) error {
...
// AssertRecurseImplementedComponentRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ImplementedComponent (e.g. [][]ImplementedComponent), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseImplementedComponentRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aImplementedComponent, ok := obj.(ImplementedComponent)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertImplementedComponentRequired(aImplementedComponent)
	})
}
