...
// AssemblyOscalImplementationCommonProtocol - Information about the protocol used to provide a service.
type AssemblyOscalImplementationCommonProtocol struct {
...
// AssertAssemblyOscalImplementationCommonProtocolRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalImplementationCommonProtocolRequired(obj AssemblyOscalImplementationCommonProtocol) error {
...
// AssertRecurseAssemblyOscalImplementationCommonProtocolRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalImplementationCommonProtocol (e.g. [][]AssemblyOscalImplementationCommonProtocol), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalImplementationCommonProtocolRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalImplementationCommonProtocol, ok := obj.(AssemblyOscalImplementationCommonProtocol)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalImplementationCommonProtocolRequired(aAssemblyOscalImplementationCommonProtocol)
	})
}
