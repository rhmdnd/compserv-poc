...
type ProfilesProfileIdImportedCatalogsCatalogIdIncludeControls struct {

	WithIds []string `json:"with-ids,omitempty"`
}

// AssertProfilesProfileIdImportedCatalogsCatalogIdIncludeControlsRequired checks if the required fields are not zero-ed
func AssertProfilesProfileIdImportedCatalogsCatalogIdIncludeControlsRequired(obj ProfilesProfileIdImportedCatalogsCatalogIdIncludeControls) error {
	return nil
}

// AssertRecurseProfilesProfileIdImportedCatalogsCatalogIdIncludeControlsRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ProfilesProfileIdImportedCatalogsCatalogIdIncludeControls (e.g. [][]ProfilesProfileIdImportedCatalogsCatalogIdIncludeControls), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseProfilesProfileIdImportedCatalogsCatalogIdIncludeControlsRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aProfilesProfileIdImportedCatalogsCatalogIdIncludeControls, ok := obj.(ProfilesProfileIdImportedCatalogsCatalogIdIncludeControls)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertProfilesProfileIdImportedCatalogsCatalogIdIncludeControlsRequired(aProfilesProfileIdImportedCatalogsCatalogIdIncludeControls)
	})
}
