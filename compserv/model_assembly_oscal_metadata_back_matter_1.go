...
// AssemblyOscalMetadataBackMatter1 - A collection of resources, which may be included directly or by reference.
type AssemblyOscalMetadataBackMatter1 struct {

	Resources []Resource1 `json:"resources,omitempty"`
}

// AssertAssemblyOscalMetadataBackMatter1Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataBackMatter1Required(obj AssemblyOscalMetadataBackMatter1) error {
	for _, el := range obj.Resources {
		if err := AssertResource1Required(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertRecurseAssemblyOscalMetadataBackMatter1Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataBackMatter1 (e.g. [][]AssemblyOscalMetadataBackMatter1), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataBackMatter1Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataBackMatter1, ok := obj.(AssemblyOscalMetadataBackMatter1)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataBackMatter1Required(aAssemblyOscalMetadataBackMatter1)
	})
}
