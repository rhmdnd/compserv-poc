...
type OscalComponentDefinitionComponentControlImplementation struct {

	ControlImplementation AssemblyOscalComponentDefinitionControlImplementation `json:"control-implementation,omitempty"`
}

// AssertOscalComponentDefinitionComponentControlImplementationRequired checks if the required fields are not zero-ed
func AssertOscalComponentDefinitionComponentControlImplementationRequired(obj OscalComponentDefinitionComponentControlImplementation) error {
	if err := AssertAssemblyOscalComponentDefinitionControlImplementationRequired(obj.ControlImplementation); err != nil {
		return err
	}
	return nil
}

// AssertRecurseOscalComponentDefinitionComponentControlImplementationRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of OscalComponentDefinitionComponentControlImplementation (e.g. [][]OscalComponentDefinitionComponentControlImplementation), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseOscalComponentDefinitionComponentControlImplementationRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aOscalComponentDefinitionComponentControlImplementation, ok := obj.(OscalComponentDefinitionComponentControlImplementation)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertOscalComponentDefinitionComponentControlImplementationRequired(aOscalComponentDefinitionComponentControlImplementation)
	})
}
