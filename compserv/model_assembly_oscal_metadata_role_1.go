...
// AssemblyOscalMetadataRole1 - Defines a function assumed or expected to be assumed by a party in a specific situation.
type AssemblyOscalMetadataRole1 struct {
...
// AssertAssemblyOscalMetadataRole1Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataRole1Required(obj AssemblyOscalMetadataRole1) error {
...
// AssertRecurseAssemblyOscalMetadataRole1Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataRole1 (e.g. [][]AssemblyOscalMetadataRole1), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataRole1Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataRole1, ok := obj.(AssemblyOscalMetadataRole1)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataRole1Required(aAssemblyOscalMetadataRole1)
	})
}
