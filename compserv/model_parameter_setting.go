...
// AssertParameterSettingRequired checks if the required fields are not zero-ed
func AssertParameterSettingRequired(obj ParameterSetting) error {
...
// AssertRecurseParameterSettingRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ParameterSetting (e.g. [][]ParameterSetting), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseParameterSettingRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aParameterSetting, ok := obj.(ParameterSetting)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertParameterSettingRequired(aParameterSetting)
	})
}
