...
// AssemblyOscalComponentDefinitionImportComponentDefinition - Loads a component definition from another resource.
type AssemblyOscalComponentDefinitionImportComponentDefinition struct {

	// A link to a resource that defines a set of components and/or capabilities to import into this collection.
	Href string `json:"href"`
}

// AssertAssemblyOscalComponentDefinitionImportComponentDefinitionRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalComponentDefinitionImportComponentDefinitionRequired(obj AssemblyOscalComponentDefinitionImportComponentDefinition) error {
...
// AssertRecurseAssemblyOscalComponentDefinitionImportComponentDefinitionRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalComponentDefinitionImportComponentDefinition (e.g. [][]AssemblyOscalComponentDefinitionImportComponentDefinition), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalComponentDefinitionImportComponentDefinitionRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalComponentDefinitionImportComponentDefinition, ok := obj.(AssemblyOscalComponentDefinitionImportComponentDefinition)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalComponentDefinitionImportComponentDefinitionRequired(aAssemblyOscalComponentDefinitionImportComponentDefinition)
	})
}
