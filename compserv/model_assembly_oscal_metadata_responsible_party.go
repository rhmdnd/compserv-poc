...
// AssemblyOscalMetadataResponsibleParty - A reference to a set of organizations or persons that have responsibility for performing a referenced role in the context of the containing object.
type AssemblyOscalMetadataResponsibleParty struct {
...
// AssertAssemblyOscalMetadataResponsiblePartyRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataResponsiblePartyRequired(obj AssemblyOscalMetadataResponsibleParty) error {
...
// AssertRecurseAssemblyOscalMetadataResponsiblePartyRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataResponsibleParty (e.g. [][]AssemblyOscalMetadataResponsibleParty), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataResponsiblePartyRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataResponsibleParty, ok := obj.(AssemblyOscalMetadataResponsibleParty)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataResponsiblePartyRequired(aAssemblyOscalMetadataResponsibleParty)
	})
}
