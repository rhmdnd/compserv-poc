...
// AssemblyOscalMetadataRevision1 - An entry in a sequential list of revisions to the containing document in reverse chronological order (i.e., most recent previous revision first).
type AssemblyOscalMetadataRevision1 struct {
...
// AssertAssemblyOscalMetadataRevision1Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataRevision1Required(obj AssemblyOscalMetadataRevision1) error {
...
// AssertRecurseAssemblyOscalMetadataRevision1Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataRevision1 (e.g. [][]AssemblyOscalMetadataRevision1), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataRevision1Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataRevision1, ok := obj.(AssemblyOscalMetadataRevision1)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataRevision1Required(aAssemblyOscalMetadataRevision1)
	})
}
