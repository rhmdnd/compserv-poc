...
// AssemblyOscalImplementationCommonAuthorizedPrivilege - Identifies a specific system privilege held by the user, along with an associated description and/or rationale for the privilege.
type AssemblyOscalImplementationCommonAuthorizedPrivilege struct {
...
// AssertAssemblyOscalImplementationCommonAuthorizedPrivilegeRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalImplementationCommonAuthorizedPrivilegeRequired(obj AssemblyOscalImplementationCommonAuthorizedPrivilege) error {
	elements := map[string]interface{}{
		"title": obj.Title,
		"functions-performed": obj.FunctionsPerformed,
	}
...
// AssertRecurseAssemblyOscalImplementationCommonAuthorizedPrivilegeRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalImplementationCommonAuthorizedPrivilege (e.g. [][]AssemblyOscalImplementationCommonAuthorizedPrivilege), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalImplementationCommonAuthorizedPrivilegeRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalImplementationCommonAuthorizedPrivilege, ok := obj.(AssemblyOscalImplementationCommonAuthorizedPrivilege)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalImplementationCommonAuthorizedPrivilegeRequired(aAssemblyOscalImplementationCommonAuthorizedPrivilege)
	})
}
