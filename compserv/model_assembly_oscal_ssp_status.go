...
// AssemblyOscalSspStatus - Describes the operational status of the system.
type AssemblyOscalSspStatus struct {
...
// AssertAssemblyOscalSspStatusRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalSspStatusRequired(obj AssemblyOscalSspStatus) error {
...
// AssertRecurseAssemblyOscalSspStatusRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalSspStatus (e.g. [][]AssemblyOscalSspStatus), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalSspStatusRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalSspStatus, ok := obj.(AssemblyOscalSspStatus)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalSspStatusRequired(aAssemblyOscalSspStatus)
	})
}
