...
// AssemblyOscalMetadataResponsibleParty3 - A reference to a set of organizations or persons that have responsibility for performing a referenced role in the context of the containing object.
type AssemblyOscalMetadataResponsibleParty3 struct {
...
// AssertAssemblyOscalMetadataResponsibleParty3Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataResponsibleParty3Required(obj AssemblyOscalMetadataResponsibleParty3) error {
	elements := map[string]interface{}{
		"role-id": obj.RoleId,
		"party-uuids": obj.PartyUuids,
	}
...
// AssertRecurseAssemblyOscalMetadataResponsibleParty3Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataResponsibleParty3 (e.g. [][]AssemblyOscalMetadataResponsibleParty3), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataResponsibleParty3Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataResponsibleParty3, ok := obj.(AssemblyOscalMetadataResponsibleParty3)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataResponsibleParty3Required(aAssemblyOscalMetadataResponsibleParty3)
	})
}
