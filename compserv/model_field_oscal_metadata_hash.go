...
// FieldOscalMetadataHash - A representation of a cryptographic digest generated over a resource using a specified hash algorithm.
type FieldOscalMetadataHash struct {
...
// AssertFieldOscalMetadataHashRequired checks if the required fields are not zero-ed
func AssertFieldOscalMetadataHashRequired(obj FieldOscalMetadataHash) error {
...
// AssertRecurseFieldOscalMetadataHashRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of FieldOscalMetadataHash (e.g. [][]FieldOscalMetadataHash), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseFieldOscalMetadataHashRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aFieldOscalMetadataHash, ok := obj.(FieldOscalMetadataHash)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertFieldOscalMetadataHashRequired(aFieldOscalMetadataHash)
	})
}
