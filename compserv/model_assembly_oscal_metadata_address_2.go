...
// AssemblyOscalMetadataAddress2 - A postal address for the location.
type AssemblyOscalMetadataAddress2 struct {
...
// AssertAssemblyOscalMetadataAddress2Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataAddress2Required(obj AssemblyOscalMetadataAddress2) error {
	return nil
}

// AssertRecurseAssemblyOscalMetadataAddress2Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataAddress2 (e.g. [][]AssemblyOscalMetadataAddress2), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataAddress2Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataAddress2, ok := obj.(AssemblyOscalMetadataAddress2)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataAddress2Required(aAssemblyOscalMetadataAddress2)
	})
}
