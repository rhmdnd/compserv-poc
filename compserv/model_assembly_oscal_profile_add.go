...
// AssemblyOscalProfileAdd - Specifies contents to be added into controls, in resolution
type AssemblyOscalProfileAdd struct {
...
// AssertAssemblyOscalProfileAddRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalProfileAddRequired(obj AssemblyOscalProfileAdd) error {
...
// AssertRecurseAssemblyOscalProfileAddRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalProfileAdd (e.g. [][]AssemblyOscalProfileAdd), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalProfileAddRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalProfileAdd, ok := obj.(AssemblyOscalProfileAdd)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalProfileAddRequired(aAssemblyOscalProfileAdd)
	})
}
