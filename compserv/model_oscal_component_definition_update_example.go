...
type OscalComponentDefinitionUpdateExample struct {

	ComponentDefinition OscalPartialUpdateExample `json:"component-definition,omitempty"`
}

// AssertOscalComponentDefinitionUpdateExampleRequired checks if the required fields are not zero-ed
func AssertOscalComponentDefinitionUpdateExampleRequired(obj OscalComponentDefinitionUpdateExample) error {
	if err := AssertOscalPartialUpdateExampleRequired(obj.ComponentDefinition); err != nil {
		return err
	}
	return nil
}

// AssertRecurseOscalComponentDefinitionUpdateExampleRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of OscalComponentDefinitionUpdateExample (e.g. [][]OscalComponentDefinitionUpdateExample), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseOscalComponentDefinitionUpdateExampleRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aOscalComponentDefinitionUpdateExample, ok := obj.(OscalComponentDefinitionUpdateExample)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertOscalComponentDefinitionUpdateExampleRequired(aOscalComponentDefinitionUpdateExample)
	})
}
