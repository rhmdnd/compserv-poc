...
// Citation2 - A citation consisting of end note text and optional structured bibliographic data.
type Citation2 struct {
...
// AssertCitation2Required checks if the required fields are not zero-ed
func AssertCitation2Required(obj Citation2) error {
...
// AssertRecurseCitation2Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of Citation2 (e.g. [][]Citation2), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseCitation2Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aCitation2, ok := obj.(Citation2)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertCitation2Required(aCitation2)
	})
}
