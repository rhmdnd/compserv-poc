...
// AssemblyOscalComponentDefinitionIncorporatesComponent - TBD
type AssemblyOscalComponentDefinitionIncorporatesComponent struct {
...
// AssertAssemblyOscalComponentDefinitionIncorporatesComponentRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalComponentDefinitionIncorporatesComponentRequired(obj AssemblyOscalComponentDefinitionIncorporatesComponent) error {
...
// AssertRecurseAssemblyOscalComponentDefinitionIncorporatesComponentRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalComponentDefinitionIncorporatesComponent (e.g. [][]AssemblyOscalComponentDefinitionIncorporatesComponent), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalComponentDefinitionIncorporatesComponentRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalComponentDefinitionIncorporatesComponent, ok := obj.(AssemblyOscalComponentDefinitionIncorporatesComponent)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalComponentDefinitionIncorporatesComponentRequired(aAssemblyOscalComponentDefinitionIncorporatesComponent)
	})
}
