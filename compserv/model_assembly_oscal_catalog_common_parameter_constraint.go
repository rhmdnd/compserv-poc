...
// AssemblyOscalCatalogCommonParameterConstraint - A formal or informal expression of a constraint or test
type AssemblyOscalCatalogCommonParameterConstraint struct {
...
// AssertAssemblyOscalCatalogCommonParameterConstraintRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalCatalogCommonParameterConstraintRequired(obj AssemblyOscalCatalogCommonParameterConstraint) error {
...
// AssertRecurseAssemblyOscalCatalogCommonParameterConstraintRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalCatalogCommonParameterConstraint (e.g. [][]AssemblyOscalCatalogCommonParameterConstraint), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalCatalogCommonParameterConstraintRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalCatalogCommonParameterConstraint, ok := obj.(AssemblyOscalCatalogCommonParameterConstraint)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalCatalogCommonParameterConstraintRequired(aAssemblyOscalCatalogCommonParameterConstraint)
	})
}
