...
// AssemblyOscalMetadataParty - A responsible entity which is either a person or an organization.
type AssemblyOscalMetadataParty struct {
	...
	Addresses []AssemblyOscalMetadataAddress `json:"addresses,omitempty"`
...
// AssertAssemblyOscalMetadataPartyRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataPartyRequired(obj AssemblyOscalMetadataParty) error {
	...
	for _, el := range obj.Addresses {
		if err := AssertAssemblyOscalMetadataAddressRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertRecurseAssemblyOscalMetadataPartyRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataParty (e.g. [][]AssemblyOscalMetadataParty), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataPartyRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataParty, ok := obj.(AssemblyOscalMetadataParty)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataPartyRequired(aAssemblyOscalMetadataParty)
	})
}
