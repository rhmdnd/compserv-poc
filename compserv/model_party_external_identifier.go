...
// AssertPartyExternalIdentifierRequired checks if the required fields are not zero-ed
func AssertPartyExternalIdentifierRequired(obj PartyExternalIdentifier) error {
...
// AssertRecursePartyExternalIdentifierRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of PartyExternalIdentifier (e.g. [][]PartyExternalIdentifier), otherwise ErrTypeAssertionError is thrown.
func AssertRecursePartyExternalIdentifierRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aPartyExternalIdentifier, ok := obj.(PartyExternalIdentifier)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertPartyExternalIdentifierRequired(aPartyExternalIdentifier)
	})
}
