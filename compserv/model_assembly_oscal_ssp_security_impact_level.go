...
// AssemblyOscalSspSecurityImpactLevel - The overall level of expected impact resulting from unauthorized disclosure, modification, or loss of access to information.
type AssemblyOscalSspSecurityImpactLevel struct {
...
// AssertAssemblyOscalSspSecurityImpactLevelRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalSspSecurityImpactLevelRequired(obj AssemblyOscalSspSecurityImpactLevel) error {
	elements := map[string]interface{}{
		"security-objective-confidentiality": obj.SecurityObjectiveConfidentiality,
		"security-objective-integrity": obj.SecurityObjectiveIntegrity,
		"security-objective-availability": obj.SecurityObjectiveAvailability,
	}
...
// AssertRecurseAssemblyOscalSspSecurityImpactLevelRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalSspSecurityImpactLevel (e.g. [][]AssemblyOscalSspSecurityImpactLevel), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalSspSecurityImpactLevelRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalSspSecurityImpactLevel, ok := obj.(AssemblyOscalSspSecurityImpactLevel)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalSspSecurityImpactLevelRequired(aAssemblyOscalSspSecurityImpactLevel)
	})
}
