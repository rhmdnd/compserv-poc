...
// AssemblyOscalSspImplementedRequirement - Describes how the system satisfies an individual control.
type AssemblyOscalSspImplementedRequirement struct {
	...
	Statements []AssemblyOscalSspStatement `json:"statements,omitempty"`

	ByComponents []AssemblyOscalSspByComponent `json:"by-components,omitempty"`

	// Additional commentary on the containing object.
	Remarks string `json:"remarks,omitempty"`
}

// AssertAssemblyOscalSspImplementedRequirementRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalSspImplementedRequirementRequired(obj AssemblyOscalSspImplementedRequirement) error {
	...
	for _, el := range obj.Statements {
		if err := AssertAssemblyOscalSspStatementRequired(el); err != nil {
			return err
		}
	}
	for _, el := range obj.ByComponents {
		if err := AssertAssemblyOscalSspByComponentRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertRecurseAssemblyOscalSspImplementedRequirementRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalSspImplementedRequirement (e.g. [][]AssemblyOscalSspImplementedRequirement), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalSspImplementedRequirementRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalSspImplementedRequirement, ok := obj.(AssemblyOscalSspImplementedRequirement)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalSspImplementedRequirementRequired(aAssemblyOscalSspImplementedRequirement)
	})
}
