...
// AssemblyOscalMetadataMetadata2 - Provides information about the publication and availability of the containing document.
type AssemblyOscalMetadataMetadata2 struct {
	...
	Revisions []AssemblyOscalMetadataRevision2 `json:"revisions,omitempty"`
	...
	Roles []AssemblyOscalMetadataRole2 `json:"roles,omitempty"`

	Locations []AssemblyOscalMetadataLocation2 `json:"locations,omitempty"`

	Parties []AssemblyOscalMetadataParty2 `json:"parties,omitempty"`

	ResponsibleParties []AssemblyOscalMetadataResponsibleParty2 `json:"responsible-parties,omitempty"`

	// Additional commentary on the containing object.
	Remarks string `json:"remarks,omitempty"`
}

// AssertAssemblyOscalMetadataMetadata2Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataMetadata2Required(obj AssemblyOscalMetadataMetadata2) error {
	...
	for _, el := range obj.Revisions {
		if err := AssertAssemblyOscalMetadataRevision2Required(el); err != nil {
			return err
		}
	}
	...
	for _, el := range obj.Roles {
		if err := AssertAssemblyOscalMetadataRole2Required(el); err != nil {
			return err
		}
	}
	for _, el := range obj.Locations {
		if err := AssertAssemblyOscalMetadataLocation2Required(el); err != nil {
			return err
		}
	}
	for _, el := range obj.Parties {
		if err := AssertAssemblyOscalMetadataParty2Required(el); err != nil {
			return err
		}
	}
	for _, el := range obj.ResponsibleParties {
		if err := AssertAssemblyOscalMetadataResponsibleParty2Required(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertRecurseAssemblyOscalMetadataMetadata2Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataMetadata2 (e.g. [][]AssemblyOscalMetadataMetadata2), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataMetadata2Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataMetadata2, ok := obj.(AssemblyOscalMetadataMetadata2)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataMetadata2Required(aAssemblyOscalMetadataMetadata2)
	})
}
