...
// AssemblyOscalProfileCustom - A Custom element frames a structure for embedding represented controls in resolution.
type AssemblyOscalProfileCustom struct {
...
// AssertAssemblyOscalProfileCustomRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalProfileCustomRequired(obj AssemblyOscalProfileCustom) error {
...
// AssertRecurseAssemblyOscalProfileCustomRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalProfileCustom (e.g. [][]AssemblyOscalProfileCustom), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalProfileCustomRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalProfileCustom, ok := obj.(AssemblyOscalProfileCustom)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalProfileCustomRequired(aAssemblyOscalProfileCustom)
	})
}
