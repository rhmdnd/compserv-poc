...
// AssemblyOscalSspControlImplementation - Describes how the system satisfies a set of controls.
type AssemblyOscalSspControlImplementation struct {
	...
	ImplementedRequirements []AssemblyOscalSspImplementedRequirement `json:"implemented-requirements"`
}

// AssertAssemblyOscalSspControlImplementationRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalSspControlImplementationRequired(obj AssemblyOscalSspControlImplementation) error {
	...
	for _, el := range obj.ImplementedRequirements {
		if err := AssertAssemblyOscalSspImplementedRequirementRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertRecurseAssemblyOscalSspControlImplementationRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalSspControlImplementation (e.g. [][]AssemblyOscalSspControlImplementation), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalSspControlImplementationRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalSspControlImplementation, ok := obj.(AssemblyOscalSspControlImplementation)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalSspControlImplementationRequired(aAssemblyOscalSspControlImplementation)
	})
}
