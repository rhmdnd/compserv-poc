...
// AssertInformationTypeCategorizationRequired checks if the required fields are not zero-ed
func AssertInformationTypeCategorizationRequired(obj InformationTypeCategorization) error {
...
// AssertRecurseInformationTypeCategorizationRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of InformationTypeCategorization (e.g. [][]InformationTypeCategorization), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseInformationTypeCategorizationRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aInformationTypeCategorization, ok := obj.(InformationTypeCategorization)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertInformationTypeCategorizationRequired(aInformationTypeCategorization)
	})
}
