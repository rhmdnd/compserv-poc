...
// AssemblyOscalImplementationCommonImplementationStatus - Indicates the degree to which the a given control is implemented.
type AssemblyOscalImplementationCommonImplementationStatus struct {
...
// AssertAssemblyOscalImplementationCommonImplementationStatusRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalImplementationCommonImplementationStatusRequired(obj AssemblyOscalImplementationCommonImplementationStatus) error {
...
// AssertRecurseAssemblyOscalImplementationCommonImplementationStatusRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalImplementationCommonImplementationStatus (e.g. [][]AssemblyOscalImplementationCommonImplementationStatus), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalImplementationCommonImplementationStatusRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalImplementationCommonImplementationStatus, ok := obj.(AssemblyOscalImplementationCommonImplementationStatus)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalImplementationCommonImplementationStatusRequired(aAssemblyOscalImplementationCommonImplementationStatus)
	})
}
