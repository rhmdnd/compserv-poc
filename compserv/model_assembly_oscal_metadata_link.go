...
// AssemblyOscalMetadataLink - A reference to a local or remote resource
type AssemblyOscalMetadataLink struct {
...
// AssertAssemblyOscalMetadataLinkRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataLinkRequired(obj AssemblyOscalMetadataLink) error {
...
// AssertRecurseAssemblyOscalMetadataLinkRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataLink (e.g. [][]AssemblyOscalMetadataLink), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataLinkRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataLink, ok := obj.(AssemblyOscalMetadataLink)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataLinkRequired(aAssemblyOscalMetadataLink)
	})
}
