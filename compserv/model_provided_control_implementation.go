...
// AssertProvidedControlImplementationRequired checks if the required fields are not zero-ed
func AssertProvidedControlImplementationRequired(obj ProvidedControlImplementation) error {
...
// AssertRecurseProvidedControlImplementationRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of ProvidedControlImplementation (e.g. [][]ProvidedControlImplementation), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseProvidedControlImplementationRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aProvidedControlImplementation, ok := obj.(ProvidedControlImplementation)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertProvidedControlImplementationRequired(aProvidedControlImplementation)
	})
}
