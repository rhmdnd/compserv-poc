...
// AvailabilityImpactLevel - The expected level of impact resulting from the disruption of access to or use of the described information or the information system.
...
// AssertAvailabilityImpactLevelRequired checks if the required fields are not zero-ed
func AssertAvailabilityImpactLevelRequired(obj AvailabilityImpactLevel) error {
...
// AssertRecurseAvailabilityImpactLevelRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AvailabilityImpactLevel (e.g. [][]AvailabilityImpactLevel), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAvailabilityImpactLevelRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAvailabilityImpactLevel, ok := obj.(AvailabilityImpactLevel)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAvailabilityImpactLevelRequired(aAvailabilityImpactLevel)
	})
}
