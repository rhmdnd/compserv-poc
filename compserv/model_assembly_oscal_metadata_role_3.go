...
// AssemblyOscalMetadataRole3 - Defines a function assumed or expected to be assumed by a party in a specific situation.
type AssemblyOscalMetadataRole3 struct {
...
// AssertAssemblyOscalMetadataRole3Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataRole3Required(obj AssemblyOscalMetadataRole3) error {
...
// AssertRecurseAssemblyOscalMetadataRole3Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataRole3 (e.g. [][]AssemblyOscalMetadataRole3), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataRole3Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataRole3, ok := obj.(AssemblyOscalMetadataRole3)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataRole3Required(aAssemblyOscalMetadataRole3)
	})
}
