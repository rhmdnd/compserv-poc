...
// FieldOscalMetadataTelephoneNumber - Contact number by telephone.
type FieldOscalMetadataTelephoneNumber struct {
...
// AssertFieldOscalMetadataTelephoneNumberRequired checks if the required fields are not zero-ed
func AssertFieldOscalMetadataTelephoneNumberRequired(obj FieldOscalMetadataTelephoneNumber) error {
...
// AssertRecurseFieldOscalMetadataTelephoneNumberRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of FieldOscalMetadataTelephoneNumber (e.g. [][]FieldOscalMetadataTelephoneNumber), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseFieldOscalMetadataTelephoneNumberRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aFieldOscalMetadataTelephoneNumber, ok := obj.(FieldOscalMetadataTelephoneNumber)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertFieldOscalMetadataTelephoneNumberRequired(aFieldOscalMetadataTelephoneNumber)
	})
}
