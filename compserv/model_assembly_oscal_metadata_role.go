...
// AssemblyOscalMetadataRole - Defines a function assumed or expected to be assumed by a party in a specific situation.
type AssemblyOscalMetadataRole struct {
...
// AssertAssemblyOscalMetadataRoleRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataRoleRequired(obj AssemblyOscalMetadataRole) error {
...
// AssertRecurseAssemblyOscalMetadataRoleRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataRole (e.g. [][]AssemblyOscalMetadataRole), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataRoleRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataRole, ok := obj.(AssemblyOscalMetadataRole)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataRoleRequired(aAssemblyOscalMetadataRole)
	})
}
