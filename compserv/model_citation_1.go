...
// Citation1 - A citation consisting of end note text and optional structured bibliographic data.
type Citation1 struct {
...
// AssertCitation1Required checks if the required fields are not zero-ed
func AssertCitation1Required(obj Citation1) error {
...
// AssertRecurseCitation1Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of Citation1 (e.g. [][]Citation1), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseCitation1Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aCitation1, ok := obj.(Citation1)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertCitation1Required(aCitation1)
	})
}
