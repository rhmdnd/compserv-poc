...
// AssertAssemblyOscalMetadataRevisionRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataRevisionRequired(obj AssemblyOscalMetadataRevision) error {
...
// AssertRecurseAssemblyOscalMetadataRevisionRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataRevision (e.g. [][]AssemblyOscalMetadataRevision), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataRevisionRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataRevision, ok := obj.(AssemblyOscalMetadataRevision)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataRevisionRequired(aAssemblyOscalMetadataRevision)
	})
}
