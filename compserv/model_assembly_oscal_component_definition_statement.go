...
// AssemblyOscalComponentDefinitionStatement - Identifies which statements within a control are addressed.
type AssemblyOscalComponentDefinitionStatement struct {
...
// AssertAssemblyOscalComponentDefinitionStatementRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalComponentDefinitionStatementRequired(obj AssemblyOscalComponentDefinitionStatement) error {
	elements := map[string]interface{}{
		"statement-id": obj.StatementId,
		"uuid": obj.Uuid,
...
// AssertRecurseAssemblyOscalComponentDefinitionStatementRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalComponentDefinitionStatement (e.g. [][]AssemblyOscalComponentDefinitionStatement), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalComponentDefinitionStatementRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalComponentDefinitionStatement, ok := obj.(AssemblyOscalComponentDefinitionStatement)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalComponentDefinitionStatementRequired(aAssemblyOscalComponentDefinitionStatement)
	})
}
