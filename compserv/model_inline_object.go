...
type InlineObject struct {
	...
	IncludeControls []ProfilesProfileIdImportedCatalogsCatalogIdIncludeControls `json:"include-controls,omitempty"`
}
...
func AssertInlineObjectRequired(obj InlineObject) error {
	for _, el := range obj.IncludeControls {
		if err := AssertProfilesProfileIdImportedCatalogsCatalogIdIncludeControlsRequired(el); err != nil {
			return err
		}
	}
	return nil
