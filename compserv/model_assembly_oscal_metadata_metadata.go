...
// AssemblyOscalMetadataMetadata - Provides information about the publication and availability of the containing document.
type AssemblyOscalMetadataMetadata struct {
	...
	Revisions []AssemblyOscalMetadataRevision `json:"revisions,omitempty"`
	...
	Roles []AssemblyOscalMetadataRole `json:"roles,omitempty"`

	Locations []AssemblyOscalMetadataLocation `json:"locations,omitempty"`

	Parties []AssemblyOscalMetadataParty `json:"parties,omitempty"`

	ResponsibleParties []AssemblyOscalMetadataResponsibleParty `json:"responsible-parties,omitempty"`

	// Additional commentary on the containing object.
	Remarks string `json:"remarks,omitempty"`
}

// AssertAssemblyOscalMetadataMetadataRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataMetadataRequired(obj AssemblyOscalMetadataMetadata) error {
	...
	for _, el := range obj.Revisions {
		if err := AssertAssemblyOscalMetadataRevisionRequired(el); err != nil {
			return err
		}
	}
	...
	for _, el := range obj.Roles {
		if err := AssertAssemblyOscalMetadataRoleRequired(el); err != nil {
			return err
		}
	}
	for _, el := range obj.Locations {
		if err := AssertAssemblyOscalMetadataLocationRequired(el); err != nil {
			return err
		}
	}
	for _, el := range obj.Parties {
		if err := AssertAssemblyOscalMetadataPartyRequired(el); err != nil {
			return err
		}
	}
	for _, el := range obj.ResponsibleParties {
		if err := AssertAssemblyOscalMetadataResponsiblePartyRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertRecurseAssemblyOscalMetadataMetadataRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataMetadata (e.g. [][]AssemblyOscalMetadataMetadata), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataMetadataRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataMetadata, ok := obj.(AssemblyOscalMetadataMetadata)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataMetadataRequired(aAssemblyOscalMetadataMetadata)
	})
}
