...
// AssertFieldOscalMetadataDocumentIdRequired checks if the required fields are not zero-ed
func AssertFieldOscalMetadataDocumentIdRequired(obj FieldOscalMetadataDocumentId) error {
...
// AssertRecurseFieldOscalMetadataDocumentIdRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of FieldOscalMetadataDocumentId (e.g. [][]FieldOscalMetadataDocumentId), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseFieldOscalMetadataDocumentIdRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aFieldOscalMetadataDocumentId, ok := obj.(FieldOscalMetadataDocumentId)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertFieldOscalMetadataDocumentIdRequired(aFieldOscalMetadataDocumentId)
	})
}
