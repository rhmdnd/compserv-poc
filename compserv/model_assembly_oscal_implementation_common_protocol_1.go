...
// AssemblyOscalImplementationCommonProtocol1 - Information about the protocol used to provide a service.
type AssemblyOscalImplementationCommonProtocol1 struct {
	...
	PortRanges []AssemblyOscalImplementationCommonPortRange `json:"port-ranges,omitempty"`
}

// AssertAssemblyOscalImplementationCommonProtocol1Required checks if the required fields are not zero-ed
func AssertAssemblyOscalImplementationCommonProtocol1Required(obj AssemblyOscalImplementationCommonProtocol1) error {
	...
	for _, el := range obj.PortRanges {
		if err := AssertAssemblyOscalImplementationCommonPortRangeRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertRecurseAssemblyOscalImplementationCommonProtocol1Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalImplementationCommonProtocol1 (e.g. [][]AssemblyOscalImplementationCommonProtocol1), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalImplementationCommonProtocol1Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalImplementationCommonProtocol1, ok := obj.(AssemblyOscalImplementationCommonProtocol1)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalImplementationCommonProtocol1Required(aAssemblyOscalImplementationCommonProtocol1)
	})
}
