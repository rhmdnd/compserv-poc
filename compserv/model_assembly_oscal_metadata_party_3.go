...
// AssertAssemblyOscalMetadataParty3Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataParty3Required(obj AssemblyOscalMetadataParty3) error {
	...
	for _, el := range obj.Addresses {
		if err := AssertAssemblyOscalMetadataAddress3Required(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertRecurseAssemblyOscalMetadataParty3Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataParty3 (e.g. [][]AssemblyOscalMetadataParty3), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataParty3Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataParty3, ok := obj.(AssemblyOscalMetadataParty3)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataParty3Required(aAssemblyOscalMetadataParty3)
	})
}
