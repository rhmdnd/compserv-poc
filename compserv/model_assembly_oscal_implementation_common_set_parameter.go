...
// AssemblyOscalImplementationCommonSetParameter - Identifies the parameter that will be set by the enclosed value.
type AssemblyOscalImplementationCommonSetParameter struct {
...
// AssertAssemblyOscalImplementationCommonSetParameterRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalImplementationCommonSetParameterRequired(obj AssemblyOscalImplementationCommonSetParameter) error {
...
// AssertRecurseAssemblyOscalImplementationCommonSetParameterRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalImplementationCommonSetParameter (e.g. [][]AssemblyOscalImplementationCommonSetParameter), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalImplementationCommonSetParameterRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalImplementationCommonSetParameter, ok := obj.(AssemblyOscalImplementationCommonSetParameter)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalImplementationCommonSetParameterRequired(aAssemblyOscalImplementationCommonSetParameter)
	})
}
