...
// AssemblyOscalMetadataAddress1 - A postal address for the location.
type AssemblyOscalMetadataAddress1 struct {
...
// AssertAssemblyOscalMetadataAddress1Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataAddress1Required(obj AssemblyOscalMetadataAddress1) error {
	return nil
}

// AssertRecurseAssemblyOscalMetadataAddress1Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataAddress1 (e.g. [][]AssemblyOscalMetadataAddress1), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataAddress1Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataAddress1, ok := obj.(AssemblyOscalMetadataAddress1)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataAddress1Required(aAssemblyOscalMetadataAddress1)
	})
}
