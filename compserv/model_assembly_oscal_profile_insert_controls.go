...
// AssemblyOscalProfileInsertControls - Specifies which controls to use in the containing context.
type AssemblyOscalProfileInsertControls struct {
...
// AssertAssemblyOscalProfileInsertControlsRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalProfileInsertControlsRequired(obj AssemblyOscalProfileInsertControls) error {
...
// AssertRecurseAssemblyOscalProfileInsertControlsRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalProfileInsertControls (e.g. [][]AssemblyOscalProfileInsertControls), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalProfileInsertControlsRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalProfileInsertControls, ok := obj.(AssemblyOscalProfileInsertControls)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalProfileInsertControlsRequired(aAssemblyOscalProfileInsertControls)
	})
}
