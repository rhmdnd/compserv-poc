...
// Citation3 - A citation consisting of end note text and optional structured bibliographic data.
type Citation3 struct {
...
// AssertCitation3Required checks if the required fields are not zero-ed
func AssertCitation3Required(obj Citation3) error {
...
// AssertRecurseCitation3Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of Citation3 (e.g. [][]Citation3), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseCitation3Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aCitation3, ok := obj.(Citation3)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertCitation3Required(aCitation3)
	})
}
