...
// AssertInheritedControlImplementationRequired checks if the required fields are not zero-ed
func AssertInheritedControlImplementationRequired(obj InheritedControlImplementation) error {
...
// AssertRecurseInheritedControlImplementationRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of InheritedControlImplementation (e.g. [][]InheritedControlImplementation), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseInheritedControlImplementationRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aInheritedControlImplementation, ok := obj.(InheritedControlImplementation)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertInheritedControlImplementationRequired(aInheritedControlImplementation)
	})
}
