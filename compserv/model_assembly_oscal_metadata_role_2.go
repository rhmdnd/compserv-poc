...
// AssemblyOscalMetadataRole2 - Defines a function assumed or expected to be assumed by a party in a specific situation.
type AssemblyOscalMetadataRole2 struct {
...
// AssertAssemblyOscalMetadataRole2Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataRole2Required(obj AssemblyOscalMetadataRole2) error {
...
// AssertRecurseAssemblyOscalMetadataRole2Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataRole2 (e.g. [][]AssemblyOscalMetadataRole2), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataRole2Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataRole2, ok := obj.(AssemblyOscalMetadataRole2)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataRole2Required(aAssemblyOscalMetadataRole2)
	})
}
