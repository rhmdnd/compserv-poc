...
// AssemblyOscalMetadataAddress - A postal address for the location.
type AssemblyOscalMetadataAddress struct {
...
// AssertAssemblyOscalMetadataAddressRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataAddressRequired(obj AssemblyOscalMetadataAddress) error {
	return nil
}

// AssertRecurseAssemblyOscalMetadataAddressRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataAddress (e.g. [][]AssemblyOscalMetadataAddress), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataAddressRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataAddress, ok := obj.(AssemblyOscalMetadataAddress)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataAddressRequired(aAssemblyOscalMetadataAddress)
	})
}
