...
// AssemblyOscalMetadataResponsibleRole - A reference to one or more roles with responsibility for performing a function relative to the containing object.
type AssemblyOscalMetadataResponsibleRole struct {
...
// AssertAssemblyOscalMetadataResponsibleRoleRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataResponsibleRoleRequired(obj AssemblyOscalMetadataResponsibleRole) error {
...
// AssertRecurseAssemblyOscalMetadataResponsibleRoleRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataResponsibleRole (e.g. [][]AssemblyOscalMetadataResponsibleRole), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataResponsibleRoleRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataResponsibleRole, ok := obj.(AssemblyOscalMetadataResponsibleRole)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataResponsibleRoleRequired(aAssemblyOscalMetadataResponsibleRole)
	})
}
