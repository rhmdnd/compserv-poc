...
// AssertAssemblyOscalMetadataProperty2Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataProperty2Required(obj AssemblyOscalMetadataProperty2) error {
...
// AssertRecurseAssemblyOscalMetadataProperty2Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataProperty2 (e.g. [][]AssemblyOscalMetadataProperty2), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataProperty2Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataProperty2, ok := obj.(AssemblyOscalMetadataProperty2)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataProperty2Required(aAssemblyOscalMetadataProperty2)
	})
}
