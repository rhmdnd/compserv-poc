...
// AssemblyOscalMetadataLocation - A location, with associated metadata that can be referenced.
type AssemblyOscalMetadataLocation struct {
	...
	Address AssemblyOscalMetadataAddress `json:"address"`
...
// AssertAssemblyOscalMetadataLocationRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataLocationRequired(obj AssemblyOscalMetadataLocation) error {
	...
	if err := AssertAssemblyOscalMetadataAddressRequired(obj.Address); err != nil {
		return err
	}
...
// AssertRecurseAssemblyOscalMetadataLocationRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataLocation (e.g. [][]AssemblyOscalMetadataLocation), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataLocationRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataLocation, ok := obj.(AssemblyOscalMetadataLocation)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataLocationRequired(aAssemblyOscalMetadataLocation)
	})
}
