...
// AssemblyOscalCatalogCommonParameterGuideline - A prose statement that provides a recommendation for the use of a parameter.
type AssemblyOscalCatalogCommonParameterGuideline struct {

	// Prose permits multiple paragraphs, lists, tables etc.
	Prose string `json:"prose"`
}

// AssertAssemblyOscalCatalogCommonParameterGuidelineRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalCatalogCommonParameterGuidelineRequired(obj AssemblyOscalCatalogCommonParameterGuideline) error {
...
// AssertRecurseAssemblyOscalCatalogCommonParameterGuidelineRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalCatalogCommonParameterGuideline (e.g. [][]AssemblyOscalCatalogCommonParameterGuideline), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalCatalogCommonParameterGuidelineRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalCatalogCommonParameterGuideline, ok := obj.(AssemblyOscalCatalogCommonParameterGuideline)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalCatalogCommonParameterGuidelineRequired(aAssemblyOscalCatalogCommonParameterGuideline)
	})
}
