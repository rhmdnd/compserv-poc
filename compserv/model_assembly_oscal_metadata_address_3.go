...
// AssemblyOscalMetadataAddress3 - A postal address for the location.
type AssemblyOscalMetadataAddress3 struct {
...
// AssertAssemblyOscalMetadataAddress3Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataAddress3Required(obj AssemblyOscalMetadataAddress3) error {
	return nil
}

// AssertRecurseAssemblyOscalMetadataAddress3Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataAddress3 (e.g. [][]AssemblyOscalMetadataAddress3), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataAddress3Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataAddress3, ok := obj.(AssemblyOscalMetadataAddress3)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataAddress3Required(aAssemblyOscalMetadataAddress3)
	})
}
