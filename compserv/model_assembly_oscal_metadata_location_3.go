...
// AssemblyOscalMetadataLocation3 - A location, with associated metadata that can be referenced.
type AssemblyOscalMetadataLocation3 struct {
	...
	Address AssemblyOscalMetadataAddress3 `json:"address"`
...
// AssertAssemblyOscalMetadataLocation3Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataLocation3Required(obj AssemblyOscalMetadataLocation3) error {
	...
	if err := AssertAssemblyOscalMetadataAddress3Required(obj.Address); err != nil {
		return err
	}
...
// AssertRecurseAssemblyOscalMetadataLocation3Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataLocation3 (e.g. [][]AssemblyOscalMetadataLocation3), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataLocation3Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataLocation3, ok := obj.(AssemblyOscalMetadataLocation3)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataLocation3Required(aAssemblyOscalMetadataLocation3)
	})
}
