...
// AssemblyOscalImplementationCommonInventoryItem - A single managed inventory item within the system.
type AssemblyOscalImplementationCommonInventoryItem struct {
...
// AssertAssemblyOscalImplementationCommonInventoryItemRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalImplementationCommonInventoryItemRequired(obj AssemblyOscalImplementationCommonInventoryItem) error {
	...
	for _, el := range obj.ImplementedComponents {
		if err := AssertImplementedComponentRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertRecurseAssemblyOscalImplementationCommonInventoryItemRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalImplementationCommonInventoryItem (e.g. [][]AssemblyOscalImplementationCommonInventoryItem), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalImplementationCommonInventoryItemRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalImplementationCommonInventoryItem, ok := obj.(AssemblyOscalImplementationCommonInventoryItem)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalImplementationCommonInventoryItemRequired(aAssemblyOscalImplementationCommonInventoryItem)
	})
}
