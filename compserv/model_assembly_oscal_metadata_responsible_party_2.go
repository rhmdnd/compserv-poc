...
// AssemblyOscalMetadataResponsibleParty2 - A reference to a set of organizations or persons that have responsibility for performing a referenced role in the context of the containing object.
type AssemblyOscalMetadataResponsibleParty2 struct {
...
// AssertAssemblyOscalMetadataResponsibleParty2Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataResponsibleParty2Required(obj AssemblyOscalMetadataResponsibleParty2) error {
...
// AssertRecurseAssemblyOscalMetadataResponsibleParty2Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataResponsibleParty2 (e.g. [][]AssemblyOscalMetadataResponsibleParty2), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataResponsibleParty2Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataResponsibleParty2, ok := obj.(AssemblyOscalMetadataResponsibleParty2)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataResponsibleParty2Required(aAssemblyOscalMetadataResponsibleParty2)
	})
}
