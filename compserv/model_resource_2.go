...
// AssertResource2Required checks if the required fields are not zero-ed
func AssertResource2Required(obj Resource2) error {
	...
	if err := AssertCitation2Required(obj.Citation); err != nil {
		return err
	}
...
// AssertRecurseResource2Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of Resource2 (e.g. [][]Resource2), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseResource2Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aResource2, ok := obj.(Resource2)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertResource2Required(aResource2)
	})
}
