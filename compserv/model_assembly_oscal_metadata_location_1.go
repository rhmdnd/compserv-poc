...
// AssemblyOscalMetadataLocation1 - A location, with associated metadata that can be referenced.
type AssemblyOscalMetadataLocation1 struct {
	...
	Address AssemblyOscalMetadataAddress1 `json:"address"`
...
// AssertAssemblyOscalMetadataLocation1Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataLocation1Required(obj AssemblyOscalMetadataLocation1) error {
	...
	if err := AssertAssemblyOscalMetadataAddress1Required(obj.Address); err != nil {
		return err
	}
...
// AssertRecurseAssemblyOscalMetadataLocation1Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataLocation1 (e.g. [][]AssemblyOscalMetadataLocation1), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataLocation1Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataLocation1, ok := obj.(AssemblyOscalMetadataLocation1)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataLocation1Required(aAssemblyOscalMetadataLocation1)
	})
}
