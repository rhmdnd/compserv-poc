...
// AssemblyOscalComponentDefinitionImplementedRequirement - Describes how the containing component or capability implements an individual control.
type AssemblyOscalComponentDefinitionImplementedRequirement struct {
	...
	ResponsibleRoles []AssemblyOscalMetadataResponsibleRole `json:"responsible-roles,omitempty"`

	Statements []AssemblyOscalComponentDefinitionStatement `json:"statements,omitempty"`

	// Additional commentary on the containing object.
	Remarks string `json:"remarks,omitempty"`
}

// AssertAssemblyOscalComponentDefinitionImplementedRequirementRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalComponentDefinitionImplementedRequirementRequired(obj AssemblyOscalComponentDefinitionImplementedRequirement) error {
	elements := map[string]interface{}{
		"uuid": obj.Uuid,
		"control-id": obj.ControlId,
	...
	for _, el := range obj.ResponsibleRoles {
		if err := AssertAssemblyOscalMetadataResponsibleRoleRequired(el); err != nil {
			return err
		}
	}
	for _, el := range obj.Statements {
		if err := AssertAssemblyOscalComponentDefinitionStatementRequired(el); err != nil {
			return err
		}
	}
	return nil
...
// AssertRecurseAssemblyOscalComponentDefinitionImplementedRequirementRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalComponentDefinitionImplementedRequirement (e.g. [][]AssemblyOscalComponentDefinitionImplementedRequirement), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalComponentDefinitionImplementedRequirementRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalComponentDefinitionImplementedRequirement, ok := obj.(AssemblyOscalComponentDefinitionImplementedRequirement)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalComponentDefinitionImplementedRequirementRequired(aAssemblyOscalComponentDefinitionImplementedRequirement)
	})
}
