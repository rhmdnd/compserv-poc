...
// AssemblyOscalSspImportProfile - Used to import the OSCAL profile representing the system's control baseline.
type AssemblyOscalSspImportProfile struct {
...
// AssertAssemblyOscalSspImportProfileRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalSspImportProfileRequired(obj AssemblyOscalSspImportProfile) error {
...
// AssertRecurseAssemblyOscalSspImportProfileRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalSspImportProfile (e.g. [][]AssemblyOscalSspImportProfile), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalSspImportProfileRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalSspImportProfile, ok := obj.(AssemblyOscalSspImportProfile)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalSspImportProfileRequired(aAssemblyOscalSspImportProfile)
	})
}
