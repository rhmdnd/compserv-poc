...
// AssemblyOscalMetadataResponsibleRole1 - A reference to one or more roles with responsibility for performing a function relative to the containing object.
type AssemblyOscalMetadataResponsibleRole1 struct {
...
// AssertAssemblyOscalMetadataResponsibleRole1Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataResponsibleRole1Required(obj AssemblyOscalMetadataResponsibleRole1) error {
...
// AssertRecurseAssemblyOscalMetadataResponsibleRole1Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataResponsibleRole1 (e.g. [][]AssemblyOscalMetadataResponsibleRole1), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataResponsibleRole1Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataResponsibleRole1, ok := obj.(AssemblyOscalMetadataResponsibleRole1)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataResponsibleRole1Required(aAssemblyOscalMetadataResponsibleRole1)
	})
}
