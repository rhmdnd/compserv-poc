...
// AssemblyOscalImplementationCommonSetParameter1 - Identifies the parameter that will be set by the enclosed value.
type AssemblyOscalImplementationCommonSetParameter1 struct {
...
// AssertAssemblyOscalImplementationCommonSetParameter1Required checks if the required fields are not zero-ed
func AssertAssemblyOscalImplementationCommonSetParameter1Required(obj AssemblyOscalImplementationCommonSetParameter1) error {
	elements := map[string]interface{}{
		"param-id": obj.ParamId,
		"values": obj.Values,
	}
...
// AssertRecurseAssemblyOscalImplementationCommonSetParameter1Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalImplementationCommonSetParameter1 (e.g. [][]AssemblyOscalImplementationCommonSetParameter1), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalImplementationCommonSetParameter1Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalImplementationCommonSetParameter1, ok := obj.(AssemblyOscalImplementationCommonSetParameter1)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalImplementationCommonSetParameter1Required(aAssemblyOscalImplementationCommonSetParameter1)
	})
}
