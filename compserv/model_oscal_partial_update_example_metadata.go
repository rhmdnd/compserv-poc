...
type OscalPartialUpdateExampleMetadata struct {

	Title string `json:"title,omitempty"`
}

// AssertOscalPartialUpdateExampleMetadataRequired checks if the required fields are not zero-ed
func AssertOscalPartialUpdateExampleMetadataRequired(obj OscalPartialUpdateExampleMetadata) error {
	return nil
}

// AssertRecurseOscalPartialUpdateExampleMetadataRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of OscalPartialUpdateExampleMetadata (e.g. [][]OscalPartialUpdateExampleMetadata), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseOscalPartialUpdateExampleMetadataRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aOscalPartialUpdateExampleMetadata, ok := obj.(OscalPartialUpdateExampleMetadata)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertOscalPartialUpdateExampleMetadataRequired(aOscalPartialUpdateExampleMetadata)
	})
}
