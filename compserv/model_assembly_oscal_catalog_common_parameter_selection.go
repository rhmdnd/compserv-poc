...
// AssemblyOscalCatalogCommonParameterSelection - Presenting a choice among alternatives
type AssemblyOscalCatalogCommonParameterSelection struct {
...
// AssertAssemblyOscalCatalogCommonParameterSelectionRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalCatalogCommonParameterSelectionRequired(obj AssemblyOscalCatalogCommonParameterSelection) error {
	return nil
}

// AssertRecurseAssemblyOscalCatalogCommonParameterSelectionRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalCatalogCommonParameterSelection (e.g. [][]AssemblyOscalCatalogCommonParameterSelection), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalCatalogCommonParameterSelectionRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalCatalogCommonParameterSelection, ok := obj.(AssemblyOscalCatalogCommonParameterSelection)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalCatalogCommonParameterSelectionRequired(aAssemblyOscalCatalogCommonParameterSelection)
	})
}
