...
// IntegrityImpactLevel - The expected level of impact resulting from the unauthorized modification of the described information.
...
// AssertIntegrityImpactLevelRequired checks if the required fields are not zero-ed
func AssertIntegrityImpactLevelRequired(obj IntegrityImpactLevel) error {
...
// AssertRecurseIntegrityImpactLevelRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of IntegrityImpactLevel (e.g. [][]IntegrityImpactLevel), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseIntegrityImpactLevelRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aIntegrityImpactLevel, ok := obj.(IntegrityImpactLevel)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertIntegrityImpactLevelRequired(aIntegrityImpactLevel)
	})
}
