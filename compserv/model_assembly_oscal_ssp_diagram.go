...
// AssemblyOscalSspDiagram - A graphic that provides a visual representation the system, or some aspect of it.
type AssemblyOscalSspDiagram struct {
...
// AssertAssemblyOscalSspDiagramRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalSspDiagramRequired(obj AssemblyOscalSspDiagram) error {
...
// AssertRecurseAssemblyOscalSspDiagramRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalSspDiagram (e.g. [][]AssemblyOscalSspDiagram), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalSspDiagramRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalSspDiagram, ok := obj.(AssemblyOscalSspDiagram)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalSspDiagramRequired(aAssemblyOscalSspDiagram)
	})
}
