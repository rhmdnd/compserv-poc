...
// AssemblyOscalMetadataResponsibleParty1 - A reference to a set of organizations or persons that have responsibility for performing a referenced role in the context of the containing object.
type AssemblyOscalMetadataResponsibleParty1 struct {
...
// AssertAssemblyOscalMetadataResponsibleParty1Required checks if the required fields are not zero-ed
func AssertAssemblyOscalMetadataResponsibleParty1Required(obj AssemblyOscalMetadataResponsibleParty1) error {
...
// AssertRecurseAssemblyOscalMetadataResponsibleParty1Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalMetadataResponsibleParty1 (e.g. [][]AssemblyOscalMetadataResponsibleParty1), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalMetadataResponsibleParty1Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalMetadataResponsibleParty1, ok := obj.(AssemblyOscalMetadataResponsibleParty1)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalMetadataResponsibleParty1Required(aAssemblyOscalMetadataResponsibleParty1)
	})
}
