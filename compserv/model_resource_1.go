...
// Resource1 - A resource associated with content in the containing document. A resource may be directly included in the document base64 encoded or may point to one or more equivalent internet resources.
type Resource1 struct {
	...
	Citation Citation1 `json:"citation,omitempty"`
...
// AssertResource1Required checks if the required fields are not zero-ed
func AssertResource1Required(obj Resource1) error {
	...
	if err := AssertCitation1Required(obj.Citation); err != nil {
		return err
	}
...
// AssertRecurseResource1Required recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of Resource1 (e.g. [][]Resource1), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseResource1Required(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aResource1, ok := obj.(Resource1)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertResource1Required(aResource1)
	})
}
