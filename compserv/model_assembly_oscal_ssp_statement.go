...
// AssemblyOscalSspStatement - Identifies which statements within a control are addressed.
...
// AssertAssemblyOscalSspStatementRequired checks if the required fields are not zero-ed
func AssertAssemblyOscalSspStatementRequired(obj AssemblyOscalSspStatement) error {
...
// AssertRecurseAssemblyOscalSspStatementRequired recursively checks if required fields are not zero-ed in a nested slice.
// Accepts only nested slice of AssemblyOscalSspStatement (e.g. [][]AssemblyOscalSspStatement), otherwise ErrTypeAssertionError is thrown.
func AssertRecurseAssemblyOscalSspStatementRequired(objSlice interface{}) error {
	return AssertRecurseInterfaceRequired(objSlice, func(obj interface{}) error {
		aAssemblyOscalSspStatement, ok := obj.(AssemblyOscalSspStatement)
		if !ok {
			return ErrTypeAssertionError
		}
		return AssertAssemblyOscalSspStatementRequired(aAssemblyOscalSspStatement)
	})
}
